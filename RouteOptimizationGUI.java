...
public class RouteOptimizationGUI extends JFrame {
    ...
    // Method to get city name by index
    ...
    private class GraphPanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            for (String city : cityPositions.keySet()) {
                ...
                g2d.fillOval(cityPos.x - NODE_RADIUS / 2, cityPos.y - NODE_RADIUS / 2, NODE_RADIUS, NODE_RADIUS);
                g2d.drawString(city, cityPos.x + NODE_RADIUS / 2, cityPos.y + NODE_RADIUS / 2);
            }
